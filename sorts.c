...
void help(){
    printf("\nHere's help for you:\n");
    printf("command-line arguments prototype:\n");
    printf("[executable name] [options] [array type]\n");
    printf("options:\n");
    printf("-b  =  perform bubble sort\n");
    printf("-s  =  perform selection sort\n");
    printf("-i  =  perform insertion sort\n");
    printf("-m  =  perform merge sort\n");
    printf("--in  =  executes input-and-sort function\n");
    printf("--ss  =  execute a sort system\n");
    printf("--cps  =  executes char arrays print system");
    printf("--cic  =  executes a function that lets you see your array in different codes like hex and dec for instance\n");
    printf("\n[array type]:\n");
    printf("int  =  perform sort or execute input-and-sort function on an int array\n");
    printf("dbl  =  perform sort or execute input-and-sort function on a double array\n");
    printf("chr  =  perform sort or execute input-and-sort function on a char array\n");
}
